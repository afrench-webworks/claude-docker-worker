...
# Windows/Git Bash port — uses $USERPROFILE/.claude/ instead of /root/.claude/.
#
...
_CLAUDE_DIR="$(cygpath "$USERPROFILE")/.claude"
APP_KEY_FILE="$_CLAUDE_DIR/github-app-key.pem"
TOKEN_CACHE_DIR="$_CLAUDE_DIR/app-token-cache"
CLAUDE_SETTINGS_FILE="$_CLAUDE_DIR/settings.json"
